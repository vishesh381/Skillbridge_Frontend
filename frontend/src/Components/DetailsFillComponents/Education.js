...
import { updateEducation ,addArrayElement,removeArrayElement ,updateErrorMessages} from '../../Slices/dataStoreSlice'
...
function Education(props) {
  ...
  return (
        ...
        {educationHeads.map((educationHeading,index)=>{
            return(
                <div key={index}>
                    ...
                    <div className="row font">
    <div className="col-lg-6 col-12 pt-5 px-4">
        <label htmlFor="Start" className="col-md-12 col-12 col-form-label">
            FROM
        </label>
        <div className="d-flex">
            {/* Start Month */}
            <select id="StartMonth" className="form-control" value={educationHeading.startMonth}
                    onChange={(e) => {
                        dispatch(updateEducation({
                            key: 'startMonth',
                            value: e.target.value,
            ...
            {/* Start Year */}
            <select id="StartYear" className="form-control" value={educationHeading.startYear}
                    onChange={(e) => {
                        dispatch(updateEducation({
                            key: 'startYear',
                            value: e.target.value,
    ...
    <div className="col-lg-6 col-12 pt-5 px-4">
        <label htmlFor="End" className="col-md-12 col-12 col-form-label">
            TO
        </label>
        <div className="d-flex">
            {/* End Month */}
            <select id="EndMonth" className="form-control" value={educationHeading.endMonth}
                    onChange={(e) => {
                        dispatch(updateEducation({
                            key: 'endMonth',
                            value: e.target.value,
            ...
            {/* End Year */}
            <select id="EndYear" className="form-control" value={educationHeading.endYear}
                    onChange={(e) => {
                        dispatch(updateEducation({
                            key: 'endYear',
                            value: e.target.value,
