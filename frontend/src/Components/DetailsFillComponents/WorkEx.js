...
import { updateWorkEx ,addArrayElement,removeArrayElement, updateErrorMessages } from '../../Slices/dataStoreSlice'
...
function WorkEx(props) {
  ...
  return (
            ...
            return(
                <div key={index}>
                    <div className="container p-2 font" style={{textAlign:"left"}}>
                        ...
                        <div className="row font">
    <div className="col-lg-6 col-12 pt-5 px-4">
        <label htmlFor="start" className="col-sm-12 col-12 col-form-label">
            FROM
        </label>
        <div className="d-flex">
            {/* Start Month */}
            <select id="startMonth" className="form-control" value={workHeading.startMonth}
                    onChange={(e) => {
                        dispatch(updateWorkEx({
                            key: 'startMonth',
            ...
            {/* Start Year */}
            <select id="startYear" className="form-control" value={workHeading.startYear}
                    onChange={(e) => {
                        dispatch(updateWorkEx({
                            key: 'startYear',
                            value: e.target.value,
    ...
    <div className="col-lg-6 col-12 pt-5 px-4">
        <label htmlFor="end" className="col-sm-12 col-12 col-form-label">
            TO
        </label>
        <div className="d-flex">
            {/* End Month */}
            <select id="endMonth" className="form-control" value={workHeading.endMonth}
                    onChange={(e) => {
                        dispatch(updateWorkEx({
                            key: 'endMonth',
                            value: e.target.value,
            ...
            {/* End Year */}
            <select id="endYear" className="form-control" value={workHeading.endYear}
                    onChange={(e) => {
                        dispatch(updateWorkEx({
                            key: 'endYear',
                            value: e.target.value,
