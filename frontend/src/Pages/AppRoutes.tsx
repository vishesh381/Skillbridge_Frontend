...
import ResumeBuilderHome from '../Components/HomePage/ResumeBuilderHome';
import '../App.css';
import ResumeBuilderComponent from '../Components/ResumeBuilderPage/ResumeBuilderComponent';
const AppRoutes = () => {
  ...
  return (
    <BrowserRouter>
      <div className='relative overflow-hidden'>
        ...
        <Route path='/company/:name' element={<ProtectedRoute allowedRoles={['APPLICANT', 'ADMIN','EMPLOYER']}><CompanyPage /></ProtectedRoute>} />
        ...
        <Route path='/post-job/:id' element={<ProtectedRoute allowedRoles={['EMPLOYER', 'ADMIN']}><PostJobPage /></ProtectedRoute>} />
          ...
          <Route path="/resume-builder/*" element={<ProtectedRoute allowedRoles={['EMPLOYER', 'APPLICANT', 'ADMIN']}><ResumeBuilderComponent /></ProtectedRoute>}/>
          <Route path='/detailsfillingpage/*' element={<ProtectedRoute allowedRoles={['EMPLOYER', 'APPLICANT', 'ADMIN']}><DetailsFillingPage /></ProtectedRoute>} />
          <Route path='myresume' element={<ProtectedRoute allowedRoles={['EMPLOYER', 'APPLICANT', 'ADMIN']}><MyResume /></ProtectedRoute>} />
