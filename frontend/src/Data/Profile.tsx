...
const fields=[
    ...
    {label:"Company",placeholder:"Enter Company Name", options:['Google', 'Microsoft', 'Meta', 'Netflix', 'Adobe', 'Facebook', 'Amazon', 'Apple', 'Spotify' , 'PaceUniversity'], leftSection:IconBriefcase},
